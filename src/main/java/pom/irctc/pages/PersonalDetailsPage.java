...
public class PersonalDetailsPage extends GenericWrappers{
	...
	public PersonalDetailsPage clickToChooseSelectOccupation(String occupation) {
		clickByXpath(prop.getProperty("PersonalDetailsPage.ChooseSelectOccupation.Xpath"));
		return this;
	}
	...
	public PersonalDetailsPage clickOnDate(String date) {
		clickByXpath(prop.getProperty("PersonalDetailsPage.Date.Xpath"));
		return this;
	}
	
	public PersonalDetailsPage clickOnMartialStatus(String martialStatus) {
		clickByXpath(prop.getProperty("PersonalDetailsPage.MartialStatus.Xpath"));
		return this;
	}
	...
	public PersonalDetailsPage clickOnGender(String gender) {
		clickByXpath(prop.getProperty("PersonalDetailsPage.Gender.Xpath"));
		return this;
	}
	
	public PersonalDetailsPage enterEmail(String email) {
		enterByXpath(prop.getProperty("PersonalDetailsPage.Email.Xpath"), email);
		return this;
	}
